### SOURCE: https://github.com/izmailovpavel/flowgmm/blob/public/flow_ssl/distributions.py
...
class SSLGaussMixture(torch.distributions.Distribution):
    ...
    def sample(self, sample_shape, gaussian_id=None):
        if gaussian_id is not None:
            ...
            idx = np.random.choice(self.n_components, size=(n_samples, 1), p=F.softmax(self.weights, dim=0))
